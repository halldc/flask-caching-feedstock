...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/flask-caching-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/flask-caching-feedstock)
...
Once the `conda-forge` channel has been enabled, `flask-caching` can be installed with:

```
conda install flask-caching
```

It is possible to list all of the versions of `flask-caching` available on your platform with:
